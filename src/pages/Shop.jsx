        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map(({ name, price, category }, i) => (
            <motion.div
              ...
              className="group bg-dark-2 border border-green/40 shadow-[0_0_60px_rgba(90,122,43,0.6),0_0_120px_rgba(90,122,43,0.3)] hover:border-green/30 transition-all cursor-pointer"
            >
