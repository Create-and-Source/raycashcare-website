        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {upcomingEvents.map(({ title, date, location, type, desc }, i) => (
            <motion.div
              ...
              className="bg-dark-2 border border-green/40 shadow-[0_0_20px_rgba(90,122,43,0.3)] p-8"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastHighlights.map(({ title, desc }, i) => (
            <motion.div
              ...
              className="bg-dark border border-green/40 shadow-[0_0_20px_rgba(90,122,43,0.3)] p-6"
            >
