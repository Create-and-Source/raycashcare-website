        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {values.map(({ icon: Icon, title, desc }) => (
            <StaggerItem key={title}>
              <motion.div
                whileHover={{ y: -6, borderColor: 'rgba(90,122,43,0.5)', boxShadow: '0 0 5px rgba(90,122,43,0.2)' }}
                transition={{ duration: 0.2 }}
                className="bg-dark-2 border border-green/20 shadow-[0_0_3px_rgba(90,122,43,0.15)] p-8 text-center h-full"
              >
                <motion.div
